...
var content = adresse.replace('https://rya.popreach.com/ams/dotd/server/ry_dotd_service.php?cmd=getDeal&dotdParams','').replace(/%5B/g,',').replace(/%5D/g,'').replace(/=/g,':');
...
new Ajax.Request(
'https://rya.popreach.com/ams/dotd/server/ry_dotd_tracking_service.php?cmd=trackTimerPercentCompleted&dealKey='+WAEAdKey+'&timerName=rewardEnable&percentCompleted=100&ryAppId=65&signed_request='+arrWAEParams["signed_request"]+'&_=1417456865962',
{
method: 'get',
asynchronous: true,
onSuccess : function(transport){
new Ajax.Request(
'https://rya.popreach.com/ams/dotd/server/ry_dotd_service.php?cmd=reward&dotdParams%5Bplaceguid%5D='+arrWAEParams["placeguid"]+'&dotdParams%5BuserId%5D='+arrWAEParams["thirdpartyid"]+'&dotdParams%5BinitTimeStamp%5D='+arrWAEParams["timestamp"]+'&dotdParams%5Bsignature%5D='+arrWAEParams["signature"]+'&dotdParams%5BpreRewardMsg%5D=Earn Views&dealKey='+WAEAdKey+'&signed_request='+arrWAEParams["signed_request"]+'&dotdParams%5BrewardUrl%5D=https://fbeq.rockyou.com/facebook_apps/zoo/server/dotd/reward.php?parentAppId='+arrWAEParams["parentAppId"]+'%26campaign=views&ryAppId=65',
{
method: 'get',
asynchronous: true,
onSuccess : function(transport){
